/**
 *  Aeon Smart Switch Original
 *
 *  Copyright 2016 Michael Pfammatter
 *  Copyright 2015 SmartThings
 *  Original switch code by SmartThings updated to show the multiTile
 *
...
metadata {
	...
	tiles (scale:2) {
        ...
        multiAttributeTile(name:"richSwitch", type:"generic", width:6, height:4) {
